...
# Map UI product categories to local dataset CSVs
DATASETS = {
    "fitness_watch": "datasets/fitness_watch.csv",
    "iphone_16_pro_cover": "datasets/iphone_16_pro_cover.csv",
    "mousepad": "datasets/mousepad.csv",
    "office_lamp": "datasets/office_lamp.csv",
    "stapler": "datasets/stapler.csv",
    "toilet_paper": "datasets/toilet_paper.csv",
    "toothpaste": "datasets/toothpaste.csv",
    "washing_machine": "datasets/washing_machine.csv",
}
